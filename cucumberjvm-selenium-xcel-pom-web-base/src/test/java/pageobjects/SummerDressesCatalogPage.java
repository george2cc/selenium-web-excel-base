...
public class SummerDressesCatalogPage extends BaseClass {
	...
	@FindBy(how = How.ID, using = "layered_id_attribute_group_1")	public static WebElement size_short;
	@FindBy(how = How.ID, using = "layered_id_attribute_group_2")	public static WebElement size_medium;
	@FindBy(how = How.ID, using = "layered_id_attribute_group_8")	public static WebElement color_white;
	...
	// pops up on the same page
	public static class CartPopup {

		@FindBy(how = How.XPATH, using = "//span[@title='Continue shopping']")	public static WebElement continue_shopping;
		@FindBy(how = How.XPATH, using = "//span[@title='Proceed to checkout']")	public static WebElement proceed_to_checkout;
