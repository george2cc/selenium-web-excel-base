...
public class SummerDressesCatalogPageElements extends BaseClass {

	public SummerDressesCatalogPageElements(WebDriver driver) {
		super(driver);
	}

	// add all elements
	@FindBy(how = How.CLASS_NAME, using = "cat-name")	public static WebElement category_name;
